(********************************************************************************
 ...
 2. Induction schemes for univalent reflexive graphs
...
Section univalence.
  ...
  Lemma edges_from_refl {G : rxgraph} (a : G) : edges_from G a.
  Proof. exists a; apply refl. Defined.
  Lemma edges_to_refl   {G : rxgraph} (a : G) : edges_to G a.
  Proof. exists a; apply refl. Defined.
...
(** ** Induction schemes for univalent reflexive graphs *)
...
Notation "a '≈[' e  ']' b" := (disp_edge _ e a b) (at level 50) : rxgraph.
