(**
 Morphisms in the bicat of categories

 Author: B. Szilvasy

 Based on [MorphismsInBicatOfUnivCats.v].
...
Proof.
  ...
  refine (is_invertible_2cell_to_is_nat_z_iso
            _
            (HF (unit_category : category) _ _ (nat_trans_from_unit f) _)
           tt).
...
Definition adjunction_from_adjunction_cats
           {C₁ C₂ : bicat_of_cats}
...
Definition adjunction_to_adjunction_cats
           {C₁ C₂ : bicat_of_cats}
  : CategoryTheory.Adjunctions.Core.adjunction (pr1 C₁) (pr1 C₂)
    →
    Bicategories.Morphisms.Adjunctions.adjunction C₁ C₂.
...
Definition adjunction_weq_adjunction_cats
           (C₁ C₂ : bicat_of_cats)
  : Bicategories.Morphisms.Adjunctions.adjunction C₁ C₂
    ≃
    CategoryTheory.Adjunctions.Core.adjunction (pr1 C₁) (pr1 C₂).
Proof.
  use weq_iso.
  - exact adjunction_from_adjunction_cats.
  - exact adjunction_to_adjunction_cats.
  - abstract
      (intro L ;
       do 2 use pair_path_in2 ;
       apply proofirrelevance, isapropdirprod ;
       use cellset_property).
  - abstract
      (intro L ;
       use subtypePath ; [ intro ; apply isaprop_form_adjunction | ] ;
       apply idpath).
